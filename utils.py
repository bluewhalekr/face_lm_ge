...
def draw_gaze(a,b,c,d,image_in, pitchyaw, thickness=1, color=(255, 255, 0),sclae=2.0):
...
def select_device(device='', batch_size=None):
    ...
    s = "YOLOv3 🚀 (git_describe() or date_modified()) torch {}".format(torch.__version__)  # string

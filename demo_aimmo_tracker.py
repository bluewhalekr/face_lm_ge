...
def parse_args():
    ...
    parser.add_argument(
        '--snapshot',dest='snapshot', help='Path of gaze estimation model snapshot.', 
...
if __name__ == '__main__':
    ...
    # out = cv2.VideoWriter(args.vid_out, fourcc, fps, (width,height))
    ...
    with torch.no_grad():
        ...
        while success:                
            ...
            # cv2.imwrite('/data/noah/gaze_landmark.png',frame)
